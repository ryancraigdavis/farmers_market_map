function insertVendorToDB(vendor){
    ...
    req.open('POST', 'http://144.202.80.206:1359/api/vendors/add_vendor', true);
...
function deleteVendor(vendor){
    ...
    req.open('DELETE', 'http://144.202.80.206:1359/api/vendors/delete_vendor', true);
    req.setRequestHeader('Content-Type', 'application/json');
    req.addEventListener('load',function(){
      	if(req.status >= 200 && req.status < 400){
	    	data = req.responseText;
...
function updateVendor(vendor){
    ...
    req.open('PUT', 'http://144.202.80.206:1359/api/vendors/update_vendor', true);
    req.setRequestHeader('Content-Type', 'application/json');
    req.addEventListener('load',function(){
      	if(req.status >= 200 && req.status < 400){
	    	data = req.responseText;
