...
function getVendorsToAdd(){
    ...
    req.open('GET', 'http://144.202.80.206:1359/api/vendors/get_vendors', true);
...
function addVendorList(){
    ...
    req.open('POST', 'http://144.202.80.206:1359/api/vendors/add_vendor_list', true);
...
function deleteVendorsList(vendor){
    ...
    req.open('DELETE', 'http://144.202.80.206:1359/api/vendors/delete_vendor_list', true);
    req.setRequestHeader('Content-Type', 'application/json');
    req.addEventListener('load',function(){
      	if(req.status >= 200 && req.status < 400){
	    	data = req.responseText;
...
function updateVendorsList(vendor){
    ...
    req.open('PUT', 'http://144.202.80.206:1359/api/vendors/update_vendor_list', true);
    req.setRequestHeader('Content-Type', 'application/json');
    req.addEventListener('load',function(){
      	if(req.status >= 200 && req.status < 400){
	    	data = req.responseText;
...
function loadVendorList(markets){
  ...
  var req = new XMLHttpRequest();
    ...
    req.open('POST', 'http://144.202.80.206:1359/api/vendors/get_vendor_lists', true);
    req.setRequestHeader('Content-Type', 'application/json');
    req.addEventListener('load',function(){
        if(req.status >= 200 && req.status < 400){
        data = JSON.parse(req.responseText);
