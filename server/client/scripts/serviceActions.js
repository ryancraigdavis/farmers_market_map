function insertServiceToDB(service){
    ...
    req.open('POST', 'http://localhost:1359/api/services/add_service', true);
...
function deleteService(service){
    ...
    req.open('DELETE', 'http://localhost:1359/api/services/delete_service', true);
    req.setRequestHeader('Content-Type', 'application/json');
    req.addEventListener('load',function(){
      	if(req.status >= 200 && req.status < 400){
	    	data = req.responseText;
...
function updateService(service){
    ...
    req.open('PUT', 'http://localhost:1359/api/services/update_service', true);
    req.setRequestHeader('Content-Type', 'application/json');
    req.addEventListener('load',function(){
      	if(req.status >= 200 && req.status < 400){
	    	data = req.responseText;
...
function addService(){
  ...
  cell4AddName.classList.add('deleteRow')
    ...
    cell3Add.appendChild(cell3AddName);
	  cell4Add.appendChild(cell4AddName);
